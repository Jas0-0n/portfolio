...
const TextType = ({
    ...
    noDelete = false,
    accumulate = false,
    separator = " " as string | React.ReactNode | (string | React.ReactNode)[],
    ...props
            ...
            if (isDeleting) {
                ...
                if (currentCharIndex < processedText.length) {
                    ...
                    if (accumulate) {
                        ...
                        if (isLast) return;
                        const finishedText = textArray[currentTextIndex];
                        timeout = setTimeout(() => {
                            setCompletedTexts((prev) => [...prev, finishedText]);
    ...
    const renderContent = () => {
        if (accumulate) {
            return (
                <>
                    {completedTexts.map((t, i) => (
                        <span key={`completed-${i}`} className="inline">
                            {t}
                            {getSeparator(i)}
                        </span>
                    ))}
